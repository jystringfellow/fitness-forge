...
const styles = StyleSheet.create({
  ...
  exercise: { paddingTop: 9, borderTopColor: theme.colors.borderMuted, borderTopWidth: 1, gap: 3 }, exerciseName: { color: theme.colors.textSoft, fontWeight: '800' }, program: { color: theme.colors.purple, fontSize: 12, fontWeight: '800' }, result: { color: theme.colors.lime, fontWeight: '800' }, planned: { color: theme.colors.textSubtle, fontSize: 12 }, summary: { color: theme.colors.purple, fontSize: 12, fontWeight: '700' }
});
