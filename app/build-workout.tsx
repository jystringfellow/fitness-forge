...
const styles = StyleSheet.create({
  ...
  exerciseCard: { backgroundColor: theme.colors.surface, borderColor: theme.colors.borderMuted, borderWidth: 1, borderRadius: 10, padding: 15, gap: 12 }, skippedCard: { opacity: 0.55 }, exerciseHeader: { flexDirection: 'row', justifyContent: 'space-between', gap: 12 }, exerciseCopy: { flex: 1, gap: 3 }, exerciseName: { color: theme.colors.text, fontSize: 20, fontWeight: '900' }, progression: { color: theme.colors.lime, fontWeight: '700', textTransform: 'capitalize' }, cue: { color: theme.colors.textMuted, fontSize: 13, lineHeight: 18 },
